...
import { Platform, Text, View, TouchableHighlight, ScrollView, Image } from 'react-native';
...
import { Item, Grid, Col, Row, Card, CardItem, Container, Header, Input, Content, Tab, Tabs, FooterTab, Footer, Button, Icon, Left, } from 'native-base';
        ...
        return (
            <ScrollView>
                ...
                <View style={{ backgroundColor: '#F3F7FF', width: window.width, height: window.height }}>
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <View style={{flexDirection: 'column', alignItems: 'center'}}>
                                <View style={{ flexDirection: 'row' }}>
                                    ...
                                    <View style={{ flexDirection: 'column', marginLeft: 30, marginRight: 6, alignItems: 'center', width: 66, marginTop: 10 }}>
                                    ...
                                    <View style={{ flexDirection: 'column', marginLeft: 6, marginRight: 6, alignItems: 'center', width: 66, marginTop: 10 }}>
                                        <Text style={styles.numbers}>
                                            0
                                    </Text>
                                        <Text style={styles.categories}>
                                ...
                                <View style={{borderColor: "#F7B633", borderWidth: 1, borderRadius: 10, marginTop: 14, paddingLeft: 60, paddingRight: 60, paddingTop: 4, paddingBottom: 4, marginLeft: 50, marginBottom: 0}}>
                    ...
                    <View>
                        <Text style={{marginLeft: 24, marginTop: 8, fontWeight: '500', fontSize: 12, color: '#828282'}}>Hot Posts</Text>
